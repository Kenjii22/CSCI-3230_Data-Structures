...
public class Exercise28_20Extra {
  public static void main(String[] args) throws Exception {
    ...
    // Read the number pf vertices 
    System.out.println("Enter the number of vertices: ");
    String in = input.nextLine();
    int vert = Integer.parseInt(in);
    
    System.out.println("The number of vertices is " + vert);
    
    //Read all edges, create edge objects, and store them into list;
    System.out.println("Enter the edges in " + vert + " lines:");
    ...
    for(int i = 0; i < vert; i++){
        ...
        for(int z = 1; z < edge.length; z++){
            int nV = Integer.parseInt(edge[z].trim());
            eList.add(new Edge(sV, nV));
        }
    }
    
    //create graph
    UnweightedGraph g = new UnweightedGraph(eList, vert);
    g.printEdges();
